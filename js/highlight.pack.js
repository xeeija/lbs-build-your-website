...
begin:"{",end:"}",illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,n]}]}}}());hljs.registerLanguage("php",function(){"use strict";return function(e){var r={
...
contains:[e.UNDERSCORE_TITLE_MODE]},{begin:"=>"},l,s]}}}());hljs.registerLanguage("json",function(){"use strict";return function(n){var e={
...
contains:null,skip:!0})]}]}}}());hljs.registerLanguage("javascript",function(){"use strict"
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:a}}}());hljs.registerLanguage("markdown",function(){"use strict";return function(n){
